...
class _ExpertEditProfilPageState extends State<ExpertEditProfilPage> {
  ...
  final Map<String, List<String>> _specializationOptions = {
    ...
    'Vegetable Plants': [
      'Hydroponic Vegetable Specialist',
      'Tomato Specialist',
      'Chili Specialist',
      'Leafy Greens Specialist',
      'Urban Farming Specialist',
      'Organic Vegetable Specialist',
    ],
    'Medicinal Plants': [
      'Herbal Plant Specialist',
      'Aloe Vera Specialist',
      'Ginger Specialist',
      'Turmeric Specialist',
      'Mint Specialist',
      'Lemongrass Specialist',
    ],
    'Plant Disease': [
      'Plant Disease Specialist',
      'Pest Control Specialist',
      'Leaf Yellowing Specialist',
      'Root Rot Specialist',
      'Fungal Disease Specialist',
      'Nutrient Deficiency Specialist',
    ],
  };
